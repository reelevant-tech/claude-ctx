...
describe('toolImpls', () => {
  it('registers exactly 12 tools', () => {
    expect(Object.keys(toolImpls).length).toBe(12)
  })

  it('repo_overview reports the project', () => {
